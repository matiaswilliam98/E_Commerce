          ...
          <div class="col-md-7">
            <div class="card-body">
              <div class="brand-wrapper" style="text-decoration:none">
                  <a href="../"  style=" text-decoration: none"><img style="pointer-events: none;" src="../imagenes/foto.png" alt="logo" class="logo" width="85" height="85"> <b style="font-size: 28px;">E-COMMERCE</b></a>
              </div>
                  ...
                  <div class="modal fade" id="dialogo1">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <br>Sistema E-commerce no asume la responsabilidad en caso de que entregue dicha clave a terceros.
                  ...
                  <div class="modal fade" id="dialogo2">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        Sistema E-commerce usa y protege la información que es proporcionada por los usuarios al momento 
