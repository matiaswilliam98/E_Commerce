					...
					<div class="col-sm-6 ">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="tel:956-393-447""><i class="fa fa-phone"></i> +51 956 393 447</a></li>
								<li><a href="mailto:anderson.fuentes@ieee.org"><i class="fa fa-envelope"></i> anderson.fuentes@ieee.org</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a class="active">Upkeep<i class="fa fa-angle-down"></i></a>
                                                                    <ul role="menu" class="sub-menu">
                        ...
                        <div class="col-md-6">
                            <div class="text-center card-box">
                                <div class="member-card pt-2 pb-2" style="text-align: left">
                                    <h2><b>Almacén de productos</b></h2>
                                    ...
                                    <div class="panel" id="pr" style='margin-left: 13px; margin-right: 13px'>
                                        ...
                                        <div class="panel-body">
                                                <div class="col-md-4">
                                                        <div class="metric">
                                                            <div class="form-group">
                                                                <button class="btn btn-danger" data-toggle="modal" data-target="#regcategoria">NUEVA CATEGORÍA</button>
                                                            </div>
                                                        </div>
                                                </div>
                                            
                                                <div class="modal fade " id="regcategoria" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                    <div class="modal-dialog" role="document"> 
                                                         <div class="modal-content">
                                                                <div class="modal-header">
                                                                <button type="button" class="close cerrarModal" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                <h4 style="text-transform: uppercase;" class="modal-title" id="myModalLabel"><b>REGISTRAR CATEGORÍA</b></h4>
                                                                </div>
                                                                <div class="modal-body" style="text-align: justify;">
                                                                    ...
                                                                    <div class="row">
                                                                        <form action="../Controlador/OperationsAdmin.php" method="POST" id="idForm">
                                                                            <div class="col-md-12">
                                                                                    ...
                                                                                    <input type="hidden" class="form-control" name="op" value="19"/>
                                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <button type="submit" id="btnEnviar" class="btn btn-warning form-control">REGISTRAR CATEGORÍA</button>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                ...
                                                <div class="col-md-4">
                                                        <div class="metric">
                                                            <div class="form-group">
                                                                <button class="btn btn-info" data-toggle="modal" data-target="#regmarca">NUEVA MARCA</button>
                                                            </div>
                                                        </div>
                                                </div>
                                            
                                                <div class="modal fade " id="regmarca" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                    <div class="modal-dialog" role="document"> 
                                                         <div class="modal-content">
                                                                <div class="modal-header">
                                                                <button type="button" class="close cerrarModal" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                <h4 style="text-transform: uppercase;" class="modal-title" id="myModalLabel"><b>NUEVA MARCA</b></h4>
                                                                </div>
                                                                <div class="modal-body" style="text-align: justify;">
                                                                    <script type="text/javascript">
                                                                        $(document).ready(function(){
                                                                    ...
                                                                    <div class="row">
                                                                        <form action="../Controlador/OperationsAdmin.php" method="POST" id="idForm2">
                                                                            <input type="hidden" class="form-control" name="op" value="20"/>
                                                                            <div class="col-md-12">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <button type="submit" id="btnEnviar2" class="btn btn-success form-control">REGISTRAR MARCA</button>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                ...
                                                <div class="col-md-4">
                                                        <div class="metric">
                                                            <div class="form-group">
                                                                <button class="btn btn-warning" data-toggle="modal" data-target="#regproducto">NUEVO PRODUCTO</button>
                                                            </div>
                                                        </div>
                                                </div>
                                            
                                                <div class="modal fade " id="regproducto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                    <div class="modal-dialog modal-la" role="document"> 
                                                         <div class="modal-content">
                                                                <div class="modal-header">
                                                                <button type="button" class="close cerrarModal" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                <h4 style="text-transform: uppercase;" class="modal-title" id="myModalLabel"><b>NUEVO PRODUCTO EN ALMACÉN</b></h4>
                                                                </div>
                                                                <div class="modal-body" style="text-align: justify;">
                                                                    ...
                                                                    <div class="row">
                                                                        <form action="../Controlador/OperationsAdmin.php" method="POST" id="idForm3">
                                                                            <input type="hidden" class="form-control" name="op" value="21"/>
                                                                            <div class="col-md-5">
                                                                                    <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                            ...
                                                                                            <input type="number" step="0.10" class="form-control" name="precio" required/>
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                            <label for="inputMessage">CATEGORÍA: </label>
                                                                                            <select name="categ" class="form-control"  required="true">
                                                                                                    <option value="" selected="">Elegir</option>
                                                                                                    <?php $categories= $adminDAO->getAllCategorias(); ?>
                                                                                                    
                                                                                                    <?php foreach ($categories as $cat){ ?>
                                                                                                    <option value="<?=$cat['id_categ']?>"><?= strtoupper($cat['categoria'])?></option>
                                                                                                    <?php }?>
                                                                            ...
                                                                            <div class="col-md-7">
                                                                                    <div class="form-group">
                                                                                            ...
                                                                                            <select name="marca" class="form-control"  required="true">
                                                                                                    ...
                                                                                                    <?php $brands= $adminDAO->getAllMarcasGlobal(); ?>
                                                                                                    
                                                                                                    <?php foreach ($brands as $brd){ ?>
                                                                                                    <option value="<?=$brd['id_marca']?>"><?= strtoupper($brd['marca'])?></option>
                                                                                                    <?php }?>
                                                                                            </select>
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <button type="submit" id="btnEnviar3" class="btn btn-primary form-control">REGISTRAR PRODUCTO</button>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                ...
                <div class="container">
                        ...
                        <ul class="pagination" id="pagination" style="padding: 0; margin: 0">
                                ...
                                <?php if(!empty($_GET['page'])){ ?>
                                    ...
                                    <li class="<?php if($pageact==$i){?> active <?php }?>"><a href="warehouse.php?page=<?=$i?>"><?=$i?></a></li>
                                ...
                                <?php }else{?>
                                    ...
                                    <?php for ($i=1; $i<= round($paginas,0); $i++){ ?>
                                        <li class="<?php if($i==1){?> active <?php }?>"><a href="warehouse.php?page=<?=$i?>"><?=$i?></a></li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover" style="text-align: center;">
                                <thead class="thead-dark" >
                                  <tr class="table-primary" style="background-color: #009c0d; color: #fff">
