...
<div class="navbar custom-navbar navbar-fixed-top" role="navigation">
     <div class="container">
          ...
          <div class="navbar-header">
               ...
               <!-- lOGO -->
               <a href="" class="navbar-brand">Sistema E-commerce MVC</a>
          </div>
          ...
          <div class="row">
               ...
               <div class="col-md-offset-1 col-md-10 col-sm-12">
                    <div class="about-info">
                        <h2><b>¿QUÉ ES Sistema E-commerce MVC?</b></h2>
                         <h2>Es un sistema desarrollado en MVC para administradores y clientes para 
                         compra y ventas mediante un catálogo de productos.</h2>
                        <br><br>
                         <h1>En Sistema E-commerce MVC encontrarás las siguientes categorías:</h1>
                    </div>
               </div>
          ...
          <div class="row">
               ...
               <div id="owl-team" class="owl-carousel">
                    <div class="col-md-4 col-sm-4 item">
                         <div class="team-item">
                             <img src="imagenes/images/anderson.jpeg" class="img-responsive" alt="" width="350px" height="350px">
                              <div class="team-overlay">
                                   <ul class="social-icon">
                                        <li><a href="https://www.facebook.com/andersonfuentes23" target="_blank" class="fa fa-facebook"></a></li>
                                        <li><a href="https://www.linkedin.com/in/andersonfuentes/" target="_blank" class="fa fa-linkedin"></a></li>
                                        <li><a href="https://github.com/andersonfuentesp" target="_blank" class="fa fa-github"></a></li>
                                   </ul>
                              </div>
                         </div>
                         <p>Anderson Fuentes</p>
                         <h3>Web Developer y analista</h3>
                    </div>
     ...
     <div class="container">
          <div class="row">
               ...
               <div class="col-md-5 col-sm-6">
                    <h2>MARKETAPP</h2>
                    <p>Panamericana Sur Km. 16.3 <br> Villa El Salvador<br> Lima - Perú</p>
               ...
               <div class="col-md-4 col-sm-6">
                    <div class="footer-info">
                    	<h2>Conócenos</h2>
                         <p><a href="tel:010-090-0780">01 - 7153335</a></p>
                         <p><a href="mailto:anderson.fuentes@ieee.org">anderson.fuentes@ieee.org</a></p>
               ...
               <div class="col-md-12 col-sm-12">
                    <div class="copyright-text">
                         <p>MarketApp © 2022 All rights reserved 
                         
                         | Desarrollado por: Anderson Fuentes</p>
                    </div>
               </div>
